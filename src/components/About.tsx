...
const timeline = [
  ...
  { year: '2017', event: 'First International Client' },
  { year: '2019', event: 'Expanded to Cloud Services' },
  { year: '2021', event: 'AI & ML Division Launched' },
  { year: '2023', event: 'Reached 100+ Projects Milestone' },
  { year: '2024', event: 'Global Presence in 10+ Countries' },
];
  ...
  return (
    <Section id="about" background="gray">
      <div className="max-w-7xl 2xl:max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          subtitle="About Us"
          title="Driving Digital Transformation Since 2015"
          description="From a small startup to a global technology leader, our journey has been defined by innovation, excellence, and unwavering commitment to our clients' success."
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 2xl:gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 text-base 2xl:text-lg mb-4 leading-relaxed">
                RadianTech was founded in 2015 with a simple vision: to help businesses leverage technology 
                to achieve their full potential. What started as a small team of passionate developers has 
                grown into a global technology powerhouse.
              </p>
              <p className="text-gray-600 dark:text-gray-300 text-base 2xl:text-lg mb-4 leading-relaxed">
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-primary rounded-2xl p-12 text-white">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['USA', 'UK', 'Canada', 'Germany', 'UAE', 'India', 'Singapore', 'Australia'].map((country) => (
