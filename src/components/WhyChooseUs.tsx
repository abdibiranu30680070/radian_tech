...
const features = [
  {
    ...
    description: 'Proven track record of successful project deliveries across various industries.',
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    description: 'Flexible and iterative approach for faster time-to-market.',
  },
  {
    icon: Shield,
    title: 'Quality Assurance',
    description: 'Rigorous testing processes to ensure flawless software delivery.',
  },
];
