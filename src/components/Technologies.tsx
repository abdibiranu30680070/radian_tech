...
const techCategories = [
  {
    title: 'Frontend',
    technologies: ['React', 'Next.js', 'Vue', 'Angular', 'Tailwind CSS'],
    color: 'from-blue-500 to-cyan-500',
  },
  {
    title: 'Backend',
    technologies: ['Python', 'Django', 'FastAPI', 'Node.js', 'Express', 'Java Spring Boot', '.NET'],
  ...
  {
    title: 'Database',
    technologies: ['PostgreSQL', 'MySQL', 'SQL Server', 'MongoDB', 'Oracle', 'Redis'],
              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  {category.technologies.map((tech, idx) => (
                    <span
                      key={idx}
                      className="text-sm bg-primary/10 text-primary px-3 py-1 rounded-full hover:bg-primary hover:text-white transition-colors cursor-default"
                    >
                      {tech}
                    </span>
                  ))}
